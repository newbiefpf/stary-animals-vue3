  ...
  <div>
    ...
    <Row style="max-height: 330px;height: 400px;overflow: hidden">
      ...
      <Col span="10" class="ivu-pr-16">
        ...
        <Paragraph>
          <ul>
            <li v-for="item in news" style="align-items: center;user-select: none;" @click="push('/realtime_view?id='+item.id)">
      ...
      <Col span="6">
        ...
        <Paragraph>
          <div>
            <ul>
              <li v-for="item in news" @click="push('/realtime_view?id='+item.id)">
    ...
    <div style="display: flex;flex-wrap:wrap">
      <div v-for="item in newAdopts" style="width: 255px;user-select: none" @click="push('/adopt_view?id='+item.id)">
        <div style="background:#f8f8f8;padding: 3px">
          <Card :bordered="false">
            <template #title>
              <el-text size="small" style="width: 150px" truncated>{{ item.title }}</el-text>
    ...
    <div class="cardContainer">
      <div v-for="item in newSeeks" style="width: 255px;background:#f8f8f8;padding: 3px" @click="push('/seek_view?id='+item.id)">
        <Card :bordered="false">
          <template #title>
            <el-text size="small" style="width: 150px" truncated>{{ item.title }}</el-text>
            <el-text size="small" class="ivu-fr">{{ item.time }}</el-text>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      news: [
        {title: "这是信息这是信息这是信息这是信息这是信息这是信息"},
        {title: "这是信息这是信息这是信息这是信息这是信息这是信息"},
        {title: "这是信息这是信息这是信息这是信息这是信息这是信息"},
        {title: "这是信息这是信息这是信息这是信息这是信息这是信息"},
        {title: "这是信息这是信息这是信息这是信息这是信息这是信息"},
